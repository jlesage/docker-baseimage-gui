...
export LIBS="-lX11 -lxcb -lXdmcp -lXau -lXext -lXft -lfontconfig -lfreetype -lpng -lXrender -lexpat -lxml2 -lz -lbz2 -llzma -lbrotlidec -lbrotlicommon -lintl -lfribidi -lharfbuzz -lpangoxft-1.0 -lpangoft2-1.0 -lpango-1.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0 -lpcre -lgraphite2 -lffi"
export LDFLAGS="-Wl,--as-needed --static -static -Wl,--strip-all -Wl,--start-group $LIBS -Wl,--end-group"
...
#cat /tmp/openbox/Makefile
make V=1 -C /tmp/openbox -j1 #$(nproc)
